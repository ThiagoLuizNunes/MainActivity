...
public class MediaCodecWrapper {
    ...
    public static MediaCodecWrapper fromVideoFormat(final MediaFormat trackFormat,
        ...
        if (mimeType.contains("video/")) {
            ...
            trackFormat.setInteger(MediaFormat.KEY_MAX_INPUT_SIZE, 100000);
            trackFormat.setInteger(MediaFormat.KEY_DURATION, 60095000);
            //trackFormat.setInteger(MediaFormat.KEY_HEIGHT, 720);
            //trackFormat.setInteger(MediaFormat.KEY_WIDTH, 1280);
